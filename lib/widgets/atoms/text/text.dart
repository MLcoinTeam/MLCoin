...
class AtomText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      title,
      textAlign: textAlign,
      style: this.fontWeight != null
          ? TextStyle(color: color, fontSize: size, fontWeight: this.fontWeight)
          : TextStyle(
              color: color,
              fontSize: size,
            ),
...
const kTitleSectionTextStyle = TextStyle(
  color: Colors.black,
  fontSize: 17,
